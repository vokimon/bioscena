...
abocar les noms i els tipus dels agents. Després, en fa un altre per
...
Posteriorment, per a cada secció de paràmetres, la classe factoria
{\tt CAgent} determina a quin agent pertany la secció i li va enviant
noms de paràmetres i les restes de la línia corresponent per que el
agent es configuri.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Els paràmetres}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Cada subclasse de {\tt CAgent} té uns paràmetres que reconeix, i que 
pot configurar. Si un objecte agent rep un nom de parametre i un 
stream amb el valor, mira si el parèmetre és un dels que reconeix,
si sí ho és, parseja l'stream com li interesi.
Si no és un paràmetre seu, ho deixa a la subclasse.
Si arriba a {\tt CAgent} i no ha estat configurat es dóna un error.
