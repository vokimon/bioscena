...
El món implementat és una matriu bidimensional amb les vores conectades 
formant un torus. A cada posició de la matriu hi cap un organisme i 
...
condicional d'un conjunt de seqüències d'instruccions. 
Cada seqüència d'instruccions porta associada una condició que depén 
del contingut actual de la memòria fenotípica que té cada organisme.
Com a resultat de l'execució de les instruccions, el biosistema 
modifica els registres de la memòria fenotìpica, la qual cosa permet 
...
\index{mitosi}
\index{cariotip}
El sistema de control d'un organisme està codificat en el seu 
