...
Cada posició té 8 cel·les veines directes. Un desplaçament a qualsevol 
...
estandard.
%%\footnote{
Com s'explica a l'apartat \ref{TODO}, aquesta funció retorna cert si 
\begin{verbatim}
...
aquest bit no es tindrà en compte.
%%}
