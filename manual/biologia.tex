...
donen a la natura que necessitem conèixer per, posteriorment,
...
zigot que dóna un individuu diplont. Aquest crea cèl·lules esporogènees (diplonts) que
per meiosi dóna lloc a meiospores haplonts de les que es torna a formar un individuu haplont.
...
\item   En organismes pluricel·lulars, cal que sigui una mutació al teixit germinal
    que dóna lloc als nous individuus. Si es dona al teixit somàtic, només afecta
...
TODO: L'unitat de mutació, convinació... és molt més petita que un
gen.
...
TODO: No tots els promotors ténen la mateixa probabilitat de
sintetitzar-se
