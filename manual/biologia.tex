...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conceptes d'àmbit biològic}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
donen a la natura i que necessitem conèixer per, posteriorment,
aplicar-los en dos àmbits. Per un costat, necessitem conèixer els
...
Els primers estudis científics sobre genètica [MENDEL 1866] van pendre
una perspectiva externa als individus per estudiar l'herència als
organismes que es reprodueixen sexualment. És a dir, a partir dels
caràcters observables d'individus de diferents generacions, van
...
El caràcter observable en el que ens fixem l'anomenem {\bf
fenotip}\index{fenotip!concepte mendelià}, per exemple, el color dels
ulls. Un {\bf gen}\index{gen!concepte mendelià} és cadascun dels
...
quals formen el seu {\bf genotip}\index{genotip!concepte mendelià}.
...
fenotip no és directa, perquè en el fenotip pot intervenir l'entorn.
El conjunt de tots els gens que té un organisme (no pas considerant
un sol fenotip) és el {\bf genoma}\index{genoma!concepte mendelià}.

Un {\bf al·lel}\index{al·lel}, és cadascuna de les alternatives (o
...
només si, en algun cas, el fet de tenir un o l'altre afecta el
...
l'altre, diem que són {\bf gens homòlegs}\index{gen!gens homòlegs}.
El genotip és {\bf homozigot}\index{genotip!homozigot} si els seus
gens només presenten un al·lel per cada conjunt de gens homòlegs
(Raça pura). En canvi, el genotip és {\bf
...
Un individu homozigòtic presenta el caràcter fenotípic representatiu
de l'al·lel. Aquest caràcter se'n diu el fenotip homozigòtic per
aquest al·lel.
...
individus homozigòtics donen molt poca variabilitat genètica. Si una
població acaba convertint-se en homozigotica, per exemple, per
excesiva endogàmia, aquest gen es queda estancat i no dóna
...
resposta perquè dependrà de les mutacions. En els gens que no
...
letals\index{genotip!letal}. Un genotip letal és aquella combinació
...
\begin{itemize}
\item   {\bf Dominància - Recessivitat:} Un al·lel (dominant)
        s'imposa sobre l'altre (recessiu), i, el fenotip resultant
        és el mateix que el d'un homozigot amb l'al·lel dominant.
\item   {\bf Herència intermitja:} El fenotip no és l'equivalent a
        cap dels dos fenotips homozigots sinó que és un fenotip
        intermig.
\item   {\bf Codominància:} Es presenten els fenotips dels dos
        al·lels a la vegada.
\item   {\bf Superdominància o heterosis:} La presència de l'al·lel
...
El caràcter pot dependre de diversos gens {\bf poligen} amb la qual
...
identificable. A més, considerant el fet de que l'entorn afecta el
fenotip, és possible que un individu amb genotip AABBBB sigui
fenotipicament més semblant a un homozigot A que un individu amb
genotip AAABBB.
...
Una de les interaccions entre gens no homòlegs és la {\bf
epistàsia}\index{epistàsia}: un gen (epistàtic) controla l'activació
...
escollia els més apropiats per a l'entorn. Segons el concepte de Mendel
...
més endavant) és un fenòmen aleatori que es dóna amb una determinada
freqüència que sol ser molt baixa. La {\bf freqüència de mutació} és
...
d'al·lel (com es veu a la secció \ref{TeoBioMolecular}).

\label{mutacioMolecular}
Als organismes pluricel·lulars, les mutacions poden ser {\bf
somàtiques}\index{mutació!somàtica} o {\bf
germinals}\index{mutació!germinal}. Una mutació somàtica, només
afecta una cèl·lula i a totes les que en deriven. Per exemple, els
...
gametes. En conseqüència, aquesta mutació afectarà, no només la
cèl·lula i les que en derivin sinó que també la descendència.
...
aproximació, ja ens dóna alguns conceptes que no són presents a la implementació
...
Genotip que no tingui gens homòlegs té, de forma crònica, els mateixos 
...
dels algorismes genètics clàssics que revisarem més endavant.
...
De cara a l'anàlisi dels resultats, pot ser interesant detectar si 
hi ha algun mecanisme que afavoreixi els genotips heterozigots, si 
s'implementessin genotips al·lèlics, i la presència de fenotips continus.
...
Generalment un cromosòma té un punt de 


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Reproducció cel·lular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

La reproducció cel·lular ens interessa per produir-se en ella:
\begin{itemize}
\item la duplicació del material genètic
\item la seva reconvinació
\item el repartiment dels recursos
\end{itemize}

Hi ha diverses alternatives en quant al repartiment del recursos:
\begin{itemize}
\item Bipartició: La cèl·lula original reparteix els seus recursos, 
de forma més o menys equitativa, en dos cèl·lules resultants.
\item Gemació: Es genera una cèl·lula amb molts menys recursos.
\end{itemize}

En la pràctica, una organisme que adopti la segona estratègia, implica
que allarga el temps de maduració de la cèl·lula, però, que a la vegada
redueix el cost de reproducció per la qual cosa una cèl·lula madura
podrà reproduir-se més freqüentment. Aquesta característica és un 
aspecte d'adaptació, no només als organismes unicel·lulars.
...
Si bé l'objectiu de la reprodució era obtindre individus que siguin còpies
...
material genètic sense que es produeixi cap nou individu.

%TODO: La conjugacio no es algo mes? No sera altra cosa el que dius?

Dels procesos sexuals en resulta una gama d'individus diferents molt més amplia
del que en resulta amb processos exclusivament asexuals.
Això dóna més agilitat al procés evolutiu, sobretot de cara a variacions en el medi.
...
Als organismes que es reprodueixen sexualment, a la fecundació, sempre 
intervenen dos cèl·lules haplonts (gametes), una de cada progenitor, que es 
junten per formar un zigot diplont.
Pot passar que la meiosi es produeixi abans de la fecundació, i que els 
individus madurs siguin diplonts ({\bf cicle diplont}) o que la meiosis 
es produeixi després de la fecundació amb la qual cosa els individus són 
haplonts ({\bf cicle haplont}).

Alguns organismes alternen generacions haplonts amb les diplonts 
({\bf cicle haplodiplont}.
Una generació haplont produeix les gametes que intervenen a la 
fecundació, formant un zigot que dóna un individu diplont. 
Aquest crea cèl·lules esporogènees (diplonts) que
per meiosi dóna lloc a meiospores haplonts de les que es torna a formar un individu haplont.
...
El fet de que els gens estiguin dins de l'estrutura cromosòmica dóna
...
La majoria de cops una deleccío en un estadi evolutiu avançat representa gairebé sempre un efecte negatiu a l'individu que la pateix.

% TODO: Causes de la delecció

% TODO: Efectes gairebé sempre negatius

\item   La {\bf duplicació} consisteix en el fet de que un segment cromosòmic es dupliqui, generalment, en sèrie.

\item   La {\bf translocació} és una mutació cromosòmica que consisteix canviar el locus d'una seqüència gènica. Si la translocació es produeix dins d'un cromosoma molt sovint es dona juntament amb una inversió. Si es produeix entre dos cromosomes diferents, a més, pot ser recíproca o no segons l'intercanvi hagi sigut mutu.
...
juntament amb els individus i, si dos gens són bons si s'hereten junts,
...
Fins ara, hem considerat un gen com quelcom indivisible. Abans de conèixer a fons
...
El material genètic està composat d'un seguit de bases d'ADN 
...
al llarg de la qual hi ha una seqüencia de parells de bases nitrogenades.
Hi ha un total de 4 bases diferents i cada base es pot aparellar només 
amb la seva complementària.
...
L'expressió gènica\index{expressió gènica!concepte biològic} és la 
forma que tènen els gens, continguts en els cromosomes, per arribar a 
afectar el caràcter fenotípic que controlen. En general, cada gen
contingut als cromosomes està associat a la producció d'una proteina 
...
l'expressió gènica es fa en tres passos:

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Transcripció}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

La transcripció és el primer pas de l'expressió gènica i l'únic en el 
que pren part l'ADN.
Consisteix en sintetitzar una cadena d'ARN complementària a una 
subseqüència d'ADN.
...
% TODO: Comentar el tema de la direccio de transcripció. Buf... Pa ke?

\item   {\bf Fase de finalització:}
El procés arriba a la seva fi, quan l'enzim arriba a una seqüència
d'ADN determinada, {\bf regió terminadora}, que indica el seu final.
\end{itemize}
...
Les cadenes d'ARN$_m$ inmadur, a les cèl·lules eucariotes (amb nucli 
diferenciat),
...
Per un costat, la seqüència d'ADN que hi ha transcrita al ARN$_m$, 
no tota conté informació útil. Els {\bf exons} són els segments que 
codifiquen informació útil, i els {\bf introns} són els segments que 
no. Una de les transformacions que es fan en aquesta fase és eliminar 
els introns.
...
%\begin{table}
%    \centering
%    \fbox{TODO: Taula del codi genètic}
%    \caption{Codi Genètic. Diferents convinacions de codons es corresponen a un sól pèptid.}
...
de codis.
\footnote{Això dóna una idea de en quin punt de l'evolució, les mitocondries
...
l'individu que els pateix i no es pot esperar a que variï el
...
El gens tenen una {\bf probabilitat transcripció} que depèn de l'afinitat de
...
desactivi quan no hi hagi A, i/o un control positiu represible, perquè
s'acceleri la producció quan hi hagi A.
...
deguda a la inestabilitat química del propi ADN o a agents externs.
\begin{itemize}
...
Encara cal que passi per uns quants filtres perquè la mutació es
faci efectiva a la descendència:
\begin{itemize}
\item   
Existeixenn mecanismes de reparació basats en el fet de 
que, tot i que una base hagi canviat, l'altre pot seguir igual, 
si no són complementàries, vol dir que hi ha hagut una mutació. 
L'enzim corrector modifica una de les dues bases per tal de que 
siguin complementàries, però, pot modificar la mutada o la bona.
\item   
En duplicar-se la cadena, per una divisió cel·lular, 
si encara no s'ha 'corregit´ la mutació, la meitat de la 
descendència durà la mutació complerta i l'altra meitat el genoma 
primitiu.
\item   
Tant si es repara com si es queda la mutació sense reparar, 
la probabilitat de traspasar-la a un descendent és del 50\%.
\item
La mutació es pot produir a un segment d'ADN no codificant 
(introns i zones intermitges)
\item
Els codons sinònims fan que alguns canvis en les bases no 
impliquin canvi de pèptid.
% TODO: Calcular el tant percent, quan tinguis una estona
\item
Alguns canvis de pèptids als extrons tampoc no són 
significatius pel fenotip donat que la proteina resultant
manté la seva funcionalitat.
% TODO: Referència a Kimura
\item
En organismes pluricel·lulars, cal que sigui una mutació al 
teixit germinal que dóna lloc als nous individus. 
Si es dona al teixit somàtic, només afecta les cèl·lules 
...
longitud dels gens/paràmetres \cite{ptGAs}. Raich va trobar ideal una 
codificació molt semblant (feia servir una longitud en comptes d'una 
seqüència terminadora) per problemes orientats a disseny que ténen un 
nombre variable de paràmetres i que requereixen solucions obertes 
\cite{RedundanciaRaich}.

Els introns, les zones promotores i terminadores i les zones entre
gens, són exemples de seqüències no codificants o redundant.
Un dels factors d'èxit d'aquestes codificacions és el fet de que
les mutacions no tènen perqué sempre ser destructives mantenint una
variabiliat genètica que no afecta a l'individu. 

La programació genètica sovint necessita aquest tipus de solucions
obertes i sovint fan servir codificació redundant o de cromosoma 
de longitud variable. 
He trobat moltes discrepàncies en la bibliografia de PG sobre el 
paper de les zones no codificants.

Resumo a continuació alguns punts remarcables el procés d'expressió gènica.

\begin{itemize}
\item El mateix procés de codificació està implementat per enzims i ARN que, 
de la mateixa manera, provenen directament de l'ADN, és a dir, 
la codificació depèn del mateix genoma. 
Evidentment, aquests procesos no estan subjectes a molta variablilitat, 
donat que una mutació en aspectes tan bàsics com es la traducció seria 
letal, fins i tot pels organismes mes senzills.
\item El material transcrit no s'expressa tal qual si no que pateix un 
procés de maduració que elimina introns i fa afegits per fer-ho 
'executable' pels ribosomes.
\item Hi ha mecanismes de regulació activa que afecten directament a la 
síntesis. En aquests mecanismes ens centrarem, doncs són els que 
donen als organismes la capacitat d'adaptar-se al canvi.
\end{itemize}

Per acabar, m'agradaria contrastar el concepte clàssic de gen que vaig
comentar amb el que es pot dir després d'haver introduït els nous conceptes:
\begin{itemize}
\item Un gen ja no és allò que controla un caracter sinó allò que controla
una proteïna.
\item Un caràcter vindrà controlat per diversos gens que es reprimeixen o es potencien formant un complex genètic.
\item La unitat bàsica de mutació es la base. Tot i així, pot modificar-se la
base i no quedar afectat el gen.
\item La unitat bàsica de reconvinació és la base. Les zones intergèniques permeten minimitzar el fet de que un gen quedi partit.
\end{itemize}


% TODO: La síntesis és direccional
% TODO: Algunes mutacions directes no permeses
% TODO: Possible codificació de les mutacións bàsiques
