...
Els arxius estan distribuïts en diversos directoris:
\begin{description}
\item[\tt Bin/] Conté l'executable per a MS-DOS generat amb DJGPP i 
els arxius de configuració.
També hi ha alguns exemples d'arxius de configuració alternatius.
\item[\tt Docs/] Conté documentació útil pel desenvolupament i 
manteniment, com ara l'arxiu {\tt TODO.txt}.
...
generar-ho.
\item[\tt Utils/] Conté algunes aplicacions complementàries.
\end{description}
...
{\bf L'executable necessita una consola de text de 80x50 (o més) que 
interpreti correctament seqüències de terminal ANSI.}
...
gràfics a l'arxiu font {\tt BiosistemaProves.cpp} i recompilar.
...
% TODO: Insertar pantalla configurant 80X50 Windows95
