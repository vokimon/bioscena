...
Posibles problemes:
\begin{itemize}
\item Si teniu una versió del compilador o de les llibreries de C++
inferior a la 2.8, dóna problemes al voltant de la línia 170 de 
Cariotip.cpp.
...
estableix el protocol que han de seguir les subclasses, perquè la
...
\item   Un {\bf constructor} significatiu per a la topologia. Per exemple, en
    ...
    El constructor de CTopologia simplement reserva espai per N caselles.
