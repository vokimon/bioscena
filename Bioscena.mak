...
CLEAN :
	...
	-@erase "$(INTDIR)\BiosistemaProves.obj"
...
CLEAN :
	...
	-@erase "$(INTDIR)\BiosistemaProves.obj"
	-@erase "$(INTDIR)\BiosistemaProves.sbr"
	-@erase "$(INTDIR)\Biotop.obj"
...
"$(INTDIR)\BiosistemaProves.obj" : $(SOURCE) $(DEP_CPP_BIOSIS) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "Bioscena - Win32 Debug"


"$(INTDIR)\BiosistemaProves.obj"	"$(INTDIR)\BiosistemaProves.sbr" : $(SOURCE)\
 $(DEP_CPP_BIOSIS) "$(INTDIR)"
...
"$(INTDIR)\Taxonomista.obj"	"$(INTDIR)\Taxonomista.sbr" : $(SOURCE)\
 $(DEP_CPP_TAXON) "$(INTDIR)"
...
"$(INTDIR)\turbioconio.obj"	"$(INTDIR)\turbioconio.sbr" : $(SOURCE)\
 $(DEP_CPP_TURBI) "$(INTDIR)"
