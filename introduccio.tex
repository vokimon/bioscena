...
\begin{description}
\item [Eines d'anàlisis:] Han de poder donar informació útil del 
que està passant al biosistema: Per això, cal dividir la comunitat 
...
%TODO: Abocat a disc, si o no? De moment no, pero si sí que.
...
\footnote{Per diferenciant-les de les gèniques o les cromosòmiques. Els
...
alguns dels quals s'introduiran en el projecte. Es fa un anàlisi de
