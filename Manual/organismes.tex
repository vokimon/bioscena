...
\index{sistema metabòlic}
\index{pap|see{sistema de metabòlic}}
\index{sistema de memòria|see{fenotip}}
...
\index{regulació!biològica de la expressió gènica}
...
perquè la seqüencia de la zona estructural es pugui executar.
...
\index{zona operadora}
\index{codó}
Cada codó (part elemental de traducció) de la zona operadora codifica 
una condició. 
...
\index{cromosoma!transcripció}
\index{cromosoma!transcripció|see{transcripció}}
\index{transcripció|see{cromosoma!transcripció}}
