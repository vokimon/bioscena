...
%    \includegraphics[width=6.1 in, keepaspectratio, draft]{compatibilitat2}
    \framebox[6.2 in]{TODO: Posar la gràfica del funcionament que hi ha a la presentació Power Point}
...
\begin{enumerate}
\item Quan un organisme neix, es genera un sistema de control a partir del cariotip i s'inicialitzen el fenotip i el sistema metabòlic.
...
determinista (apartat \ref{TODO}) i l'execució d'una mateixa cerca
pot donar resultats diferents.
...
de maniobra per evolucionar estrategies no optimes. 
...
%    \includegraphics[width=6.1 in, keepaspectratio, draft]{disipable}
    \framebox[6.2 in]{TODO: Esquema dels contenidors d'energia}
    \caption{Disipació de l'energia}
    \label{fig:disipacio}
\end{figure}
...
descendència (mutacions germinals, veure l'apartat \ref{mutacioMolecular}).
